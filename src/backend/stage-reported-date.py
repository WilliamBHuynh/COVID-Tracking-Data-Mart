...
sqlInsert = """ INSERT INTO d_reported_date (reported_date_key, day, month, day_of_week, week_in_year, holiday,
    season, weekend, year, date_full_format) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s) """
for idx, row in data.iterrows():
    record = (row["Reported_Date_Surrogate_Key"], row["Day"], row["Month"], row["Day_of_Week"], row["Week_of_Year"],
